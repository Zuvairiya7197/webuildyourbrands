...
export default function Hero({
  ...
  const renderHeroLink = (href: string, label: string) => {
    ...
    const Icon =
      href === CALENDLY_URL || normalizedLabel.includes("book")
        ? CalendarDays
            ...
            : normalizedLabel.includes("pricing") ||
              ...
              : normalizedLabel.includes("story") ||
                ...
                : normalizedLabel.includes("work") ||
                    normalizedLabel.includes("project")
                  ? BriefcaseBusiness
                  : Eye;
    const icon = (
      <Icon
    ...
    <section className="relative overflow-hidden px-4 pb-10 pt-8 sm:px-8 sm:pt-12 lg:px-24 lg:pt-14 xl:px-32">
      ...
      <div className="relative mx-auto flex min-h-[clamp(420px,calc(100svh-12rem),620px)] max-w-6xl items-center justify-center text-center">
        <div className="w-full max-w-5xl">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-sm leading-7 text-white/68 drop-shadow-[0_6px_18px_rgba(0,0,0,0.75)] sm:mt-7 sm:text-lg sm:leading-8 lg:mt-5 lg:text-lg">
            {description}
          </p>
