...
export default function WebStorePage() {
  return (
    <>
      <section className="relative overflow-hidden px-4 pb-16 pt-20 sm:px-8 sm:pb-20 sm:pt-20 lg:min-h-[100svh] lg:px-24 lg:pb-10 lg:pt-20 xl:px-32">
        ...
        <div className="relative mx-auto grid max-w-6xl gap-10 lg:min-h-[calc(100svh-5rem)] lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
