...
export default function Home() {
  return (
    <>
      <section className="relative flex min-h-[100svh] items-center overflow-hidden bg-[#00001f] px-4 pb-12 pt-[calc(5rem+env(safe-area-inset-top)+2rem)] sm:px-8 sm:pb-16 sm:pt-28 lg:items-start lg:px-24 lg:pb-10 lg:pt-32 xl:px-32">
        <video
